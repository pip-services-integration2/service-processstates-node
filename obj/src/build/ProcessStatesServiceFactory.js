...
const ProcessStatesCommandableHttpServiceV1_1 = require("../services/version1/ProcessStatesCommandableHttpServiceV1");
...
class ProcessStatesServiceFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(ProcessStatesServiceFactory.HttpServiceDescriptor, ProcessStatesCommandableHttpServiceV1_1.ProcessStatesCommandableHttpServiceV1);
...
ProcessStatesServiceFactory.HttpServiceDescriptor = new pip_services3_commons_nodex_1.Descriptor("service-processstates", "service", "commandable-http", "*", "1.0");
