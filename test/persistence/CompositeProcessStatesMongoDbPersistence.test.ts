...
import { CompositeProcessStatesMongoDbPersistence } from '../../src/persistence/CompositeProcessStatesMongoDbPersistence';
import { ProcessStatesPersistenceFixture } from './ProcessStatesPersistenceFixture';

suite('CompositeProcessStatesMongoDbPersistence', ()=> {
    let persistence: CompositeProcessStatesMongoDbPersistence;
    ...
    setup(async () => {
        ...
        persistence = new CompositeProcessStatesMongoDbPersistence();
